...
<head>
    ...
    <title>Coordinator Attendance Dashboard</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-user-cog me-2"></i>Coordinator Dashboard
            </a>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group mb-4">
                            ...
                            <a href="bulk_attendance.php" class="list-group-item list-group-item-action">
                                <i class="fas fa-users me-2"></i>Bulk Attendance
                            </a>
                        </div>
                        <h4 class="mb-3"><i class="fas fa-link text-primary me-2"></i>Quick Links</h4>
                        <div class="list-group">
                            <a href="attendance_settings.php" class="list-group-item list-group-item-action">
