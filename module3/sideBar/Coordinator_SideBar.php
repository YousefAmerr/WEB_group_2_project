...
<div class="sidebar">
  ...
  <div class="sidebar-nav">
    <div class="nav-item"><i class="material-icons">dashboard</i><a href="/eng/coordinator_dashboard.php">Dashboard</a></div>
    <div class="nav-divider">COMPONENTS</div>
    <div class="nav-item"><i class="material-icons">list</i><a href="/eng/view_attendance.php">View Attendance</a></div>
    <div class="nav-item"><i class="material-icons">file_download</i><a href="/eng/export_attendance.php">Export Attendance</a></div>
