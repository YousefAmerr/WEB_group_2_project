...
<div class="sidebar">
  ...
  <div class="sidebar-nav">
    <div class="nav-item"><i class="material-icons">dashboard</i><a href="/eng/student_dashboard.php">Dashboard</a></div>
    <div class="nav-divider">COMPONENTS</div>
    <div class="nav-item"><i class="material-icons">event</i><a href="/eng/studentevent.php">View Events</a></div>
    <div class="nav-item"><i class="material-icons">assignment</i><a href="/eng/claimAward.php">Claim Merit Award</a></div>
    <div class="nav-item"><i class="material-icons">list</i><a href="/eng/student_dashboard.php">View Attendance</a></div>
    <div class="nav-item"><i class="material-icons">qr_code</i><a href="/eng/student_checkin_slots.php" target="_blank">Check-In QR</a></div>
    <div class="nav-divider">COMMITTEE</div>
    <div class="nav-item"><i class="material-icons">group</i><a href="#">Committee Info</a></div>
  </div>
</div>
